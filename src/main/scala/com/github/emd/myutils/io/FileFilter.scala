...
/** File filter. */
final class RichFileFilter(val asFilter: FileFilter) extends FileFilterOps {
 ...
 * Links are followed.
 */
object RegularFileFilter extends FileFilter {
